...
namespace ProjectProduk
{
    class Program
    {
        ...
        static void TambahProduk()
        {
            ...
            produk.KodeProd = Console.ReadLine();
            Console.Write("Nama Produk : ");
            produk.NamaProd = Console.ReadLine();
            Console.Write("Harga Beli  : ");
            produk.HarBeli = Convert.ToDouble(Console.ReadLine());
            Console.Write("Harga Jual  : ");
            produk.HarJual = Convert.ToDouble(Console.ReadLine());
        ...
        static void TampilProduk()
        {
            ...
            {
                Urut++;
                Console.WriteLine("{0}. {1}, {2}, {3:N0}, {4:N0}", Urut, produk.KodeProd, produk.NamaProd, produk.HarBeli, produk.HarJual);
            }
            if (Urut < 1)
            {
